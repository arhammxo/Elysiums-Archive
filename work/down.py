...
# location = geolocator.reverse("17.733955508597237, 83.32225367925157")
...
# g=gc.ip('me')
# cl=g.latlng
# locatio = geolocator.reverse(cl)
# address = locatio.raw['address']
# cit = address.get('city', '')
# cit=cit.strip()
# print(cit)
# print(city==cit)
...
locname = geoLoc.reverse("17.733955508597237, 83.32225367925157")       
...
ca=geoLoc.reverse("17.733955508597237, 83.32225367925157")       
